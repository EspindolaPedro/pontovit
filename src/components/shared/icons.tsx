...
export const WhatsappIcon = (props: IconProps) => <Icon {...props}><path d="M7 20.5 3.8 21.3a.5.5 0 0 1-.6-.6l.9-3.2A9 9 0 1 1 7 20.5Z" /><path d="M8.5 8.3c.2-.5.4-.5.6-.5h.5c.2 0 .4 0 .5.4.2.4.6 1.5.7 1.6.1.1.1.3 0 .5-.1.2-.2.3-.3.4l-.4.5c-.1.1-.3.3-.1.6.2.3.8 1.3 1.7 2.1 1.2 1 2.1 1.4 2.4 1.5.3.1.5.1.6-.1l.6-.7c.2-.2.4-.2.6-.1l1.5.7c.2.1.3.2.4.3.1.1.1.6-.1 1.1-.2.5-1.2 1.1-1.7 1.1-.5 0-1.1.1-3.4-.9-2.8-1.2-4.6-4.1-4.7-4.3-.1-.2-.9-1.2-.9-2.3 0-1.1.6-1.7.8-1.9Z" /></Icon>;
